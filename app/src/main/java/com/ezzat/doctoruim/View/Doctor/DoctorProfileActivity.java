...
public class DoctorProfileActivity extends AppCompatActivity {
    ...
    private LinearLayout nameL, specL, phoneL, addressL;
    private Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseController.getElement(USER_TABLE, phone1.substring(2, phone1.length()), User.class, new onEvent() {
            ...
            public void onStart(Object object) {
                Utils.showLoading(DoctorProfileActivity.this);
            }
            ...
            public void onEnd(Object object) {
                ...
                try {
                    Glide.with(DoctorProfileActivity.this).load(currentUser.getImage()).placeholder(getImage(PLACEHOLDER_IMG)).into(photo);
                } catch (Exception e) {
                    Glide.with(DoctorProfileActivity.this).load(getImage(PLACEHOLDER_IMG)).into(photo);
                }

                DatabaseController.getElement(DOCTOR_TABLE, phone1.substring(2, phone1.length()), Doctor.class, new onEvent() {
                    @Override
                    public void onStart(Object object) {
                        Utils.showLoading(DoctorProfileActivity.this);
                    }
        ...
        specL.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                viewDialog(spec, "specialization");
            }
        });
    ...
    public void viewDialog(final TextView v, final String attribute) {
        ...
        SweetAlertDialog alertDialog = new SweetAlertDialog(DoctorProfileActivity.this, SweetAlertDialog.NORMAL_TYPE);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PICK_IMAGE && resultCode == RESULT_OK && data != null && data.getData() != null) {
            ...
            try {
                Glide.with(DoctorProfileActivity.this).load(uriProfileImage).placeholder(getImage(PLACEHOLDER_IMG)).into(photo);
            ...
            profileImageRef.putFile(uriProfileImage)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            Utils.hideDialog();
                            Toast.makeText(DoctorProfileActivity.this, "Profile", Toast.LENGTH_SHORT).show();
    ...
    private boolean attemptSave() {
        ...
        String specText = String.valueOf(spec.getText());
        ...
        if (TextUtils.isEmpty(specText)) {
            spec.setError("Spec is required");
            focusView = spec;
            cancel = true;
